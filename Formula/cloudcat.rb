class Cloudcat < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/jonathansudhakar1/cloudcat/releases/download/v0.3.1/cloudcat-0.3.1-macos-arm64.tar.gz"
      sha256 "449774b8002b7e4c9b436a78956d3f07184838cc3df831ec370835f1d3037d02"
    end
    on_intel do
