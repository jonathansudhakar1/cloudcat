class Cloudcat < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/jonathansudhakar1/cloudcat/releases/download/v0.3.2/cloudcat-0.3.2-macos-arm64.tar.gz"
      sha256 "9f339a49d8dae2bad861a3b2f4a2dcdab822d5b9b6c9af81a6ad6d2016178ec1"
    end
    on_intel do
