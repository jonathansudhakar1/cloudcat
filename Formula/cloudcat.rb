class Cloudcat < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/jonathansudhakar1/cloudcat/releases/download/v0.6.2/cloudcat-0.6.2-macos-arm64.tar.gz"
      sha256 "35dab6212d5832ba5176fe9e1a190db5cc3a59fbf3bfc1dfe36e644419cbfbcb"
    end
    on_intel do
