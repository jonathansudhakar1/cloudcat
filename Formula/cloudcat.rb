class Cloudcat < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/jonathansudhakar1/cloudcat/releases/download/v0.3.5/cloudcat-0.3.5-macos-arm64.tar.gz"
      sha256 "e9964fcde601b7ef2139afa4c64b655ce8a714a33770ddcea57bc7462f4b4ab2"
    end
    on_intel do
