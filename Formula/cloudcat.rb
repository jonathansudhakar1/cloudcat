class Cloudcat < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/jonathansudhakar1/cloudcat/releases/download/v0.6.0/cloudcat-0.6.0-macos-arm64.tar.gz"
      sha256 "ce9c9070ceb3443a1b790cfc18860ea7394e80f5c48f787933f1a646f40a539c"
    end
    on_intel do
